            ...
            {results.length > 0 ? (
                ...
                <div className="results-table-container">
                  <table className="results-table">
                    <thead>
                      <tr>
                        {[
                          "Postal Code", "Name", "Address", "Phone",
                          "Website", "Maps URL", "City", "Country",
                        ].map((h) => (
                      ...
                      {results.map((row, i) => (
                        <tr key={i} className="table-row">
                          ...
                          <td className="table-cell">
                            {row.Website && row.Website !== "Not Available" ? (
                              <a
                                href={row.Website}
                                target="_blank"
              ...
              <div className="empty-results">
                ...
                <p className="empty-text">
                  Fill in the form and click Start Search.
                </p>
              </div>
            )}
          </div>
