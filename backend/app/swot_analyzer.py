...
Extracts place-specific insights from review text rather than
using fixed rating-tier templates.
"""
...
def _extract_theme_sentiments(reviews: List[Dict]) -> Dict[str, Dict]:
    """
    Scan every review sentence, find which themes it mentions,
    score it with VADER, and accumulate per-theme stats.
    """
    theme_data = {
